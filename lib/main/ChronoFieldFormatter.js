...
(function (ChronoField) {
    /** Year. */
    ChronoField[ChronoField["YEAR"] = 1] = "YEAR";
    /** The month of year, from January (1) to December (12). */
    ChronoField[ChronoField["MONTH_OF_YEAR"] = 2] = "MONTH_OF_YEAR";
    /** The day of month, from 1 - 31. */
    ChronoField[ChronoField["DAY_OF_MONTH"] = 3] = "DAY_OF_MONTH";
    /** The day of the week, from Monday (1) to Sunday (7). */
    ChronoField[ChronoField["DAY_OF_WEEK"] = 4] = "DAY_OF_WEEK";
    /** The minute of the day, from 0 to 1440 (assuming exclusive maximum). */
    ChronoField[ChronoField["MINUTE_OF_DAY"] = 5] = "MINUTE_OF_DAY";
 ...
 */
function yearChronoFieldValue(n) {
 ...
 * @returns the field value
 */
function dayOfMonthChronoFieldValue(n) {
 ...
 * @returns the field value
 */
function minuteOfDayChronoFieldValue(n) {
...
export class ChronoFieldFormatter {
    ...
    #computeMonths(locale) {
        ...
        values.set(UNBOUNDED_VALUE, new ChronoFieldValue(ChronoField.MONTH_OF_YEAR, [UNBOUNDED_VALUE], Infinity));
     ...
     */
    parse(field, value, options) {
        if (!value) {
            return undefined;
        }
        const ubv = options?.unboundedValue !== undefined
    ...
    parseRange(field, value, options) {
        ...
        let result;
        if (l && r) {
            result = new IntRange(l.rangeValue === null && b ? b.min : l.rangeValue, r.rangeValue === null && b ? b.max : r.rangeValue);
        }
        else {
     ...
     */
    formatRange(field, value, options) {
        if (field === undefined ||
            field === null ||
            value === undefined ||
            value === null ||
        ...
        return (this.format(field, value.min, options) +
...
//# sourceMappingURL=ChronoFieldFormatter.js.map