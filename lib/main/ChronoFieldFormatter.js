...
(function (ChronoField) {
    ...
    ChronoField[ChronoField["DAY_OF_MONTH"] = 2] = "DAY_OF_MONTH";
    /** The day of the week, from Monday (1) to Sunday (7). */
    ChronoField[ChronoField["DAY_OF_WEEK"] = 3] = "DAY_OF_WEEK";
    /** The minute of the day, from 0 to 1440 (assuming exclusive maximum). */
    ChronoField[ChronoField["MINUTE_OF_DAY"] = 4] = "MINUTE_OF_DAY";
