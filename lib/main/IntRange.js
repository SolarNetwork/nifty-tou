...
export default class IntRange {
     ...
     */
    static parseRange(value, bounds, options) {
        ...
        const n2 = array.length > 1 ? (array[1] === ubv ? null : +array[1]) : n1;
    ...
    contains(value) {
        ...
        return ((this.#min === null || (value !== null && value >= this.#min)) &&
    ...
    mergeWith(o) {
        ...
        const a = this.#min === null || o.#min === null
            ? null
            : this.#min < o.#min
                ? this.#min
                : o.#min;
        const b = this.#max === null || o.#max === null
            ? null
            : this.#max > o.#max
                ? this.#max
                : o.#max;
     ...
     */
    static description(bounds, r, options) {
